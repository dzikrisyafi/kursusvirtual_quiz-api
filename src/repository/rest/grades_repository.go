...
func (r *gradesRepository) DeleteGrades(courseID int, at string) rest_errors.RestErr {
	response := gradesRestClient.Delete(fmt.Sprintf("/internal/grades/courses/%d?access_token=%s", courseID, at))
